...
def get_dataset(args, algorithm, dataset, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True):
    ...
    """
    from semilearn.datasets import get_cifarstl, get_pacs, get_domainnet, get_domainnet_balanced, get_digit_five
    ...
    if dataset == 'cifarstl':
        ...
        lb_dset, ulb_dset, eval_dset, out_dset, test_dset = get_digit_five(args, algorithm, num_labels, data_dir=data_dir)
    else:
        return None
